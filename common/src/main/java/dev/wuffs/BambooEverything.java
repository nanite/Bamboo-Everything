...
public class BambooEverything {
    ...
    public static final RegistrySupplier<CreativeModeTab> TAB = CREATIVE_TAB.register(BambooEverything.MOD_ID, () -> CreativeModeTab.builder(CreativeModeTab.Row.TOP, 0)
            .title(Component.translatable("itemGroup.bambooeverything.creative_tab"))
            .displayItems(
